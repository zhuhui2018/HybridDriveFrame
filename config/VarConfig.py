...
"浏览器驱动文件所在的绝对路径"
ieDriverFilePath="C:\\IEDriverServer.exe"
chromeDriverFilePath="C:\\chromedriver.exe"
firefoxDriverFilePath="C:\\geckodriver.exe"

"获取当前文件所在目录的父目录的绝对路径"
parentDirPath=os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
# print (parentDirPath)
